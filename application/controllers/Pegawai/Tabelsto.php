...
class Tabelsto extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . 'pegawai/tabelsto/index.html?q=' . urlencode($q);
            $config['first_url'] = base_url() . 'pegawai/tabelsto/index.html?q=' . urlencode($q);
        } else {
            $config['base_url'] = base_url() . 'pegawai/tabelsto/index.html';
            $config['first_url'] = base_url() . 'pegawai/tabelsto/index.html';
        }
        ...
        $this->template->tampilkan('tblsto/tabelsto_list', $data);
    }
    ...
    public function read($id) 
    {
        ...
        $data['map_one'] = $this->googlemaps->create_map();
            $this->template->tampilkan('tblsto/tabelsto_read', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('pegawai/tabelsto'));
        }
    }
    ...
    public function create() 
    {
        ...
        $this->template->tampilkan('tblsto/tabelsto_form', $data);
    }
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('pegawai/tabelsto/update_action'),
