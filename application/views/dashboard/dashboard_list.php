<section class='content-header'>
	<h1>
		DASHBOARD
        <small><a href=<?php echo base_url('dashboard'); ?>>> Data Management</a></small>
	</h1>
</section>        
...
<!--                 <h3 class='box-title'><?php echo anchor('map', '<i class="glyphicon glyphicon-globe"></i> Buka Peta', array('class' => 'btn btn-primary btn-sm','target'=>'_blank')); ?></h3>-->
			...
			<td><?php echo $dashboard->longitude ?></td>
                    <td width="140px"><?php echo $dashboard->odp ?></td>
                    
			<td style="text-align:center" width="100px">
			<?php 
			echo anchor(site_url('dashboard/read/'.$dashboard->id),'<i class="glyphicon glyphicon-globe"> Detail</i>',array('data-toggle'=>'tooltip','title'=>'Detail With Map','class'=>'btn btn-info btn-sm')); 
			echo '  ';
//                    echo anchor(site_url('dashboard/update/'.$dashboard->id),'<i class="fa fa-pencil-square-o"></i>',array('target' => '_blank','data-toggle'=>'tooltip','title'=>'Update','class'=>'btn btn-info btn-sm')); 
//			echo '  '; 
			?>
		    </td>
		      </tr>
            ...
            <div class="col-md-6">
                ...
                <?php  echo anchor(site_url('dashboard/updateODP'), ' Update' , 'class="btn btn-primary"'); ?>  
                <?php  echo anchor(site_url('dashboard/reset_flag'), ' Reset Flag' , 'class="btn btn-primary"'); ?>
		    </div>
